      ...
      <div className="bg-black py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-lg px-4 md:px-8">
          <div className="mb-6 sm:mb-10 lg:mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold text-white md:mb-6 lg:text-3xl">Your Cart</h2>
          </div>

          <div className="mb-5 flex flex-col sm:mb-8 sm:divide-y sm:border-t sm:border-b">
            {Array(20).fill(null).map((_, inde) => (
              <div className="py-5 sm:py-8" key={inde}>
                <div className="flex flex-wrap gap-4 sm:py-2.5 lg:gap-6">
                  ...
                  <div className="flex flex-1 flex-col justify-between">
                    <div>
                      <a href="#" className="mb-1 inline-block text-lg font-bold text-gray-100 transition duration-100 hover:text-gray-500 lg:text-xl">Top</a>

                      <span className="block text-gray-200">Size: S</span>
                      <span className="block text-gray-300">Color: White</span>
                    </div>

                    <div>
                      <span className="mb-1 block font-bold text-gray-100 md:text-lg">$15.00</span>
                  ...
                  <div className="flex w-full justify-between border-t pt-4 sm:w-auto sm:border-none sm:pt-0">
                    <div className="flex flex-col items-start gap-2">
                      <div className="flex h-12 w-20 overflow-hidden rounded border">
                        <input type="number" value="1" className="w-full px-4 py-2 bg-black outline-none ring-inset ring-indigo-300 transition duration-100 focus:ring" />

                        <div className="flex flex-col divide-y border-l">
                          <button className="flex w-6 flex-1 select-none items-center justify-center bg-gray-800 leading-none transition duration-100 hover:bg-gray-700">+</button>
                          <button className="flex w-6 flex-1 select-none items-center justify-center bg-gray-800 leading-none transition duration-100 hover:bg-gray-700 ">-</button>
                        </div>
                      </div>
                    ...
                    <div className="ml-4 pt-3 sm:pt-2 md:ml-8 lg:ml-16">
                      <span className="block font-bold text-white md:text-lg">$15.00</span>
                    </div>
                  </div>
                </div>
              </div>
